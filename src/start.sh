...
#RNN single
CUDA_VISIBLE_DEVICES=0 python train.py --num_workers 4 --batch_size 32 --data_path "/rhome/ghao004/bigdata/lstm_splicing/structure_new2_GM12878_reg_256_maxsite512_singlesite/" --model="single" --task="reg" 2>&1 | tee log_single_reg_GM12878_removed_apr18.txt
